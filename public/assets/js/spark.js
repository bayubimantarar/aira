var Spark = {
  ...
  createSnackbars: function(){
    MDSnackbars.init();
    setTimeout(function(){
      MDSnackbars.hide({text: 'Good afternoon Lucy!', timeout:7500, align: 'right', animation: 'slideup'});
    }, 1500);
    setTimeout(function(){
      MDSnackbars.hide({text: '<strong>Robert says:</strong> Good work yesterday! Lunch at 2pm?', timeout:7500, align: 'right', html: true, animation: 'slideup'});
    }, 12500);
  },
